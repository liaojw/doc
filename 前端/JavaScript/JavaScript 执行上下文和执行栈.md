...
![](/Users/ljw/Documents/Doc/image/5fked3h0qv.png)
...
![](/Users/ljw/Documents/Doc/image/k5glywrvab.png)
...
**注意 —** 对于**函数环境**，**声明式环境记录器**还包含了一个传递给函数的 `arguments` 对象（此[对象存储](https://cloud.tencent.com/product/cos?from=10680)索引和参数的映射）和传递给函数的参数的 **length**。
