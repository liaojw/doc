...
![img](https://user-gold-cdn.xitu.io/2019/5/18/16ac9daab529d6d1?imageslim)
...
![img](https://user-gold-cdn.xitu.io/2019/5/18/16ac9dae89418890?imageslim)
...
![img](https://user-gold-cdn.xitu.io/2019/5/18/16ac9db86c687566?imageslim)
...
![img](https://user-gold-cdn.xitu.io/2019/5/18/16ac9ddfc320cf54?imageslim)
...
![img](https://user-gold-cdn.xitu.io/2019/5/18/16ac9de510bd40a3?imageslim)
...
![img](https://user-gold-cdn.xitu.io/2019/5/18/16ac9de9436b0521?imageslim)
...
现在我设置了一份当用户访问呢`/admin`时渲染``的路由。当 Webpack 把一切都打包完毕之后，它会去查找`import AdminPage from './AdminPage.js'`，并且说“嘿，我需要把它包含到初始化的加载文件中”
...
在渲染函数中，在等待`>加载的过程中我们简单的渲染出`Loading...`，一旦加载成功则渲染出``
